...
const FlightAdmin = () => {
  ...
  return (
    <div className="flightAdmin-page1">
      ...
      {userDetails ?
        <>
          ...
          <div className="admin-page-cards1">

          <div className="card1 admin-card1 transactions-card1">
              <h4>Bookings</h4>
              <p> {bookingCount} </p>
              <button className="btn btn-primary" onClick={()=>navigate('/flight-bookings')}>View all</button>
          </div>

          <div className="card1 admin-card1 deposits-card1">
              <h4>Flights</h4>
              <p> {flightsCount} </p>
              <button className="btn btn-primary" onClick={()=>navigate('/flights')}>View all</button>
          </div>

          <div className="card1 admin-card1 loans-card1">
              <h4>New Flight</h4>
              <p> (new route) </p>
